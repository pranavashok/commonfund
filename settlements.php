...
<body>
	...
	<div id="transfers">
		...
		if (isset($_POST['giver']) && isset($_POST['taker']) && isset($_POST['amount'])) {
			$q = "INSERT INTO settlement VALUES(DEFAULT, " . $_POST['giver'] . ", " . $_POST['taker'] . ", " . $_POST['amount'] . ", DEFAULT);";
			if($mysqli->query($q)) {
			...
			echo '</select>	transferred <input type="text" name="amount"></input> as settlement to
